        ...
        <div className="min-h-screen bg-dashboard-bg">
            <div className="p-6 space-y-6">
                ...
                {supportChannels.length === 0 ? (
                    <Card className="bg-dashboard-card border-dashboard-border">
                        <CardContent className="p-6">
                            <p className="text-dashboard-text-secondary text-sm text-center py-4">No support channels configured</p>
                        </CardContent>
                    </Card>
                ) : (
                ...
                <Card className="bg-dashboard-card border-dashboard-border">
                    ...
                    <CardContent>
                        {faqs.length === 0 ? (
                            <p className="text-dashboard-text-secondary text-sm text-center py-8">No FAQs available</p>
                        ) : (
                            ...
                            <div>
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-dashboard-text-primary font-medium">—</span>
                                    </div>

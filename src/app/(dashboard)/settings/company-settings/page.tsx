                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="website"
                        defaultValue="https://expenseflow.com"
                      />
                    </div>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <FormFieldLogoUpload
                          ...
                          name="logo"
                          label="Business Logo"
                          description="Upload your business logo (PNG, JPG, JPEG, SVG, WEBP)"
                          maxSize={5 * 1024 * 1024}
                        />
                        <div className="space-y-2">
              ...
              <Card className="bg-dashboard-card border-dashboard-border">
                ...
                <CardContent className="space-y-4">
                  <div className="text-center p-4 bg-dashboard-accent/10 rounded-lg">
                    <h3 className="text-2xl font-bold text-dashboard-text-primary">
                      Professional
                    </h3>

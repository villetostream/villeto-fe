                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-dashboard-border">
                                <div>
                                    ...
                                    <p className="font-semibold text-dashboard-text-primary">$0.00</p>
                                </div>
                                <div>
                                    <p className="text-xs text-dashboard-text-secondary">This Month</p>
                                    <p className="font-semibold text-dashboard-text-primary">—</p>
                                </div>
                                <div>
                ...
                <Card className="bg-dashboard-card border-dashboard-border">
                    ...
                    <CardContent>
                        {accountData.accounts.length === 0 ? (
                            <p className="text-dashboard-text-secondary text-sm text-center py-8">No accounts found</p>
                        ) : (
                ...
                <Card className="bg-dashboard-card border-dashboard-border">
                    ...
                    <CardContent>
                        {accountData.recentTransactions.length === 0 ? (
                            <p className="text-dashboard-text-secondary text-sm text-center py-8">No recent transactions</p>
                        ) : (

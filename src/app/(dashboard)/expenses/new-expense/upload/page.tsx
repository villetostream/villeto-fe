...
import { ImageUpload01FreeIcons, ImageUpload01Icon, ImageUploadIcon } from "@hugeicons/core-free-icons";
    ...
    const handleProceed = async () => {
        ...
        try {
            ...
            if (files.length > 0) {
                ...
                sessionStorage.setItem("uploadedReceipts", JSON.stringify(receiptImages));
            }
        ...
        <>
            <div className="flex gap-4 pb-4 border-b border-border mb-12">
                <div>
                    ...
                    <p className="text-foreground text-xs font-medium leading-[125%]">{reportName}</p>
                </div>
                <div>
                    <Label className="text-base leading-[125%] font-medium text-foreground mb-1.5 block">
                        Report Date
                    </Label>
                    <p className="text-foreground text-xs font-medium leading-[125%]">{reportDate}</p>
                </div>
            </div>
                    ...
                    {files.length === 0 ? (
                        <>
                            <div className="mx-auto w-16 h-16 rounded-full  flex items-center justify-center mb-4">
                                <HugeiconsIcon icon={ImageUpload01Icon} className="w-8 h-8 text-muted-foreground" />
                            </div>
                    ...
                    >
                        {isProcessing ? (
                            ...
                            <>
                                ...
                                Continue with {files.length} Receipt{files.length > 1 ? "s" : ""}
                            </>
                        ) : (
                            "Upload Receipt"
                        )}

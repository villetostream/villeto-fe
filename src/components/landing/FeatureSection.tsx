...
const features = [
  {
    ...
    description: 'Empower teams to spend responsibly with our Smart Corporate Cards; track and control expenses in real time.',
    stats: '99.9% Uptime'
  },
  {
    icon: BarChart3,
    title: 'Expense Automation',
    description: 'Expense submissions and policy checks,  happen seamlessly, saving time while ensuring accuracy and compliance.',
    stats: '40% Cost Reduction'
  },
  {
    icon: Shield,
    title: 'Vendor Onboarding & Payments',
    description: 'With automated onboarding and built-in compliance checks we help you build trust and efficiency with every vendor.',
    stats: 'SOC 2 Compliant'
  },
  {
    icon: Zap,
    title: 'Accounting Automation',
    description: 'Replace spreadsheets with real-time syncing and seamless reporting that keeps your books up to date.',
    stats: '10x Faster Processing'
  },
  {
    icon: Users,
    title: 'Payroll Insight',
    description: 'Villeto gives real-time visibility into payroll, highlighting trends and discrepancies to ensure accuracy and compliance.',
    stats: '500+ Integrations'
  },
  {
    icon: Globe,
    title: 'Budgeting',
    description: 'Easily track budgets, monitor spend, and align every expense with strategy using Villeto’s real-time insights.',
    stats: '180+ Countries'
  }
]

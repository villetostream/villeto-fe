...
export interface BusinessSnapshot {
  ...
  website: string;
  logo?: string; // Added logo field for business logo preview/URL
}
...
const initialState: OnboardingState = {
  ...
  villetoProducts: [
    ...
    },
    {
      ...
      color: "bg-pink-100 border-pink-600 text-pink-700",
      selected: false,
      value: "PAYROLL_AUTOMATION",
    },
    {
      id: "5",
      ...
      color: "bg-pink-100 border-pink-600 text-pink-700",
      selected: false,
      value: "ACCOUNTS_PAYABLE_RECEIVABLE",
    },
  ],
};
